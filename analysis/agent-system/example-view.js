...
const en={
  ...
  notes:[
    ...
    'This sequence uses four continuing specialist author sessions; QA needs no separate author session here. Support and parallel work are on demand, not a permanent team. It assumes no findings, repeated controls or additional support. On return, the responsible author corrects affected work and related mechanisms, retaining valid unaffected work instead of restarting the stage. Wider authoring needs recorded impact evidence and authority. The next required fresh review keeps its own scope; Stage 2 remains full and blind.',
